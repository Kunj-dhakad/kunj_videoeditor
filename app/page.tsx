...
import { MiddleSectionVisibleaction, setActiveid } from "./store/editorSetting";
                  ...
                  <div className="video-controls">
                    ...
                    <div className="timestamp-wrapper flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="w-28 h-2 bg-gray-400 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-[--kd-background] [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:shadow-sm"
                      />
